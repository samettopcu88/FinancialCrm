...
namespace FinancialCrm
{
    public partial class FrmDashboard : Form
    {
        ...
        private void FrmDashboard_Load(object sender, System.EventArgs e)
        {
            ...
            var lastBankPrecessAmount = db.BankProcesses.OrderByDescending(x => x.BankProcessId).Take(1).Select(y => y.Amount).FirstOrDefault();
            lblLastBankProcessAmount.Text = lastBankPrecessAmount.ToString() + " ₺";
